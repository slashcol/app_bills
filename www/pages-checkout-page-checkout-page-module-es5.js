...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-checkout-page-checkout-page-module"], {
  ...
  function srcAppPagesCheckoutPageCheckoutPageModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _card_add_card_add_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _sign_in_sign_in_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    CheckoutPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      }]), _shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _address_add_address_add_module__WEBPACK_IMPORTED_MODULE_4__["AddressAddPageModule"], _card_add_card_add_module__WEBPACK_IMPORTED_MODULE_5__["CardAddPageModule"], _sign_in_sign_in_module__WEBPACK_IMPORTED_MODULE_7__["SignInPageModule"]]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](CheckoutPageModule, {
        ...
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"], _shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _address_add_address_add_module__WEBPACK_IMPORTED_MODULE_4__["AddressAddPageModule"], _card_add_card_add_module__WEBPACK_IMPORTED_MODULE_5__["CardAddPageModule"], _sign_in_sign_in_module__WEBPACK_IMPORTED_MODULE_7__["SignInPageModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppPagesCheckoutPageCheckoutPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_pipes_currency_global__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! src/app/pipes/currency-global */
    "./src/app/pipes/currency-global.ts");
    /* harmony import */


    var _address_add_address_add__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../address-add/address-add */
    "./src/app/pages/address-add/address-add.ts");
    /* harmony import */


    var _card_add_card_add__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../card-add/card-add */
    "./src/app/pages/card-add/card-add.ts");
    /* harmony import */


    var _sign_in_sign_in__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../sign-in/sign-in */
    ...
    var _components_empty_view_empty_view__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ../../components/empty-view/empty-view */
    "./src/app/components/empty-view/empty-view.ts");
    /* harmony import */


    var ngx_img_fallback__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ngx-img-fallback */
    "./node_modules/ngx-img-fallback/__ivy_ngcc__/fesm2015/ngx-img-fallback.js");
    /* harmony import */


    var ngx_skeleton_loader__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ngx-skeleton-loader */
    ...
    function CheckoutPage_empty_view_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CheckoutPage_form_11_ion_row_2_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CheckoutPage_form_11_ion_row_2_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 44);
    ...
    function CheckoutPage_form_11_ion_row_2_p_18_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_20_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_21_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_24_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-item");

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "ion-label", 49);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](2, " \xA0\xA0\xA0\xA0");
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_35_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-item");
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_47_ion_thumbnail_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_47_p_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_47_p_9_span_1_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var item_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2).$implicit;
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_47_p_9_span_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_47_p_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_47_ng_template_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "p", 34);
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_47_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        var _r26 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](11);
    ...
    function CheckoutPage_form_11_ion_row_2_ion_item_60_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CheckoutPage_form_11_ion_row_2_ion_item_60_Template_ion_button_click_4_listener() {
    ...
    function CheckoutPage_form_11_ion_row_2_p_66_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "p");
    ...
    function CheckoutPage_form_11_ion_row_2_p_77_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "p");
    ...
    function CheckoutPage_form_11_ion_row_2_ion_spinner_86_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "ion-spinner", 65);
      }
    }

    function CheckoutPage_form_11_ion_row_2_span_87_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
    ...
    function CheckoutPage_form_11_ion_row_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionChange", function CheckoutPage_form_11_ion_row_2_Template_ion_radio_group_ionChange_19_listener($event) {
          ...
          return ctx_r38.onChangePaymentMethod($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CheckoutPage_form_11_ion_row_2_Template_ion_button_click_26_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r39);

          var ctx_r40 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

          return ctx_r40.onPresentCardAddModal();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionChange", function CheckoutPage_form_11_ion_row_2_Template_ion_radio_group_ionChange_34_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r39);

          var ctx_r41 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

          return ctx_r41.onChangeAddress();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CheckoutPage_form_11_ion_row_2_Template_ion_button_click_37_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r39);

          var ctx_r42 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

          return ctx_r42.onPresentAddressAddModal();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CheckoutPage_form_11_ion_row_2_Template_ion_button_click_56_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r39);

          var ctx_r43 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

          return ctx_r43.onApplyCouponButtonTouched();
        });
    ...
    function CheckoutPage_form_11_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function CheckoutPage_form_11_Template_form_ngSubmit_0_listener() {
    ...
    function CheckoutPage_ion_row_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CheckoutPage = /*#__PURE__*/function (_base_page_base_page_) {
      _inherits(CheckoutPage, _base_page_base_page_);

      var _super = _createSuper(CheckoutPage);

      function CheckoutPage(injector, cardService, cartService, appConfig, currencyGlobalPipe, customerAddressService) {
        var _this;
        ...
        _this.currencyGlobalPipe = currencyGlobalPipe;
      ...
      _createClass(CheckoutPage, [{
        ...
        value: function setupForm() {
          ...
          var contactEmail = user.attributes.email || user.attributes.contactEmail;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 4:
                    ...
                    this.translate.get('COUPON_REMOVED').subscribe(function (str) {
        ...
        key: "onApplyCouponButtonTouched",
        value: function onApplyCouponButtonTouched() {
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 7:
                    ...
                    this.cart = cart;
                    this.isUpdatingCart = false;
                    this.translate.get('COUPON_CODE_APPLIED').subscribe(function (str) {
                  ...
                  case 13:
                    ...
                    this.isUpdatingCart = false;
                    this.showCouponErrorsIfNeeded(_context3.t0);
        ...
        key: "showCouponErrorsIfNeeded",
        value: function showCouponErrorsIfNeeded(error) {
          var _this5 = this;

          if (error.code === 5000) {
            this.translate.get('COUPON_NOT_FOUND').subscribe(function (str) {
              return _this5.showToast(str);
            });
          } else if (error.code === 5001) {
            this.translate.get('COUPON_INACTIVE').subscribe(function (str) {
              return _this5.showToast(str);
            });
          } else if (error.code === 5002) {
            this.translate.get('COUPON_USAGE_LIMIT_REACHED').subscribe(function (str) {
              return _this5.showToast(str);
            });
          } else if (error.code === 5003) {
            this.translate.get('COUPON_NOT_STARTED_YET').subscribe(function (str) {
              return _this5.showToast(str);
            });
          } else if (error.code === 5004) {
            this.translate.get('COUPON_EXPIRED').subscribe(function (str) {
              return _this5.showToast(str);
            });
          } else if (error.code === 5005) {
            this.translate.get('COUPON_USAGE_LIMIT_PER_USER_REACHED').subscribe(function (str) {
              return _this5.showToast(str);
            });
            ...
            if (matches) {
              var value = matches[1];
              var formattedValue = this.currencyGlobalPipe.transform(value);
              this.translate.get('ERROR_MINIMUM_AMOUNT_COUPON', {
            ...
            var _matches = error.message.match(/\%(.*?)\%/);

            if (_matches) {
              var _value = _matches[1];

              var _formattedValue = this.currencyGlobalPipe.transform(_value);

              this.translate.get('ERROR_MAXIMUM_AMOUNT_COUPON', {
                value: _formattedValue
              }).subscribe(function (str) {
                return _this5.showToast(str);
              });
            }
          } else if (error.code === 5008 || error.code === 5009 || error.code === 5010 || error.code === 5011 || error.code === 5012 || error.code === 5013 || error.code === 5014 || error.code === 5015 || error.code === 5016) {
            this.translate.get('CANNOT_APPLY_COUPON').subscribe(function (str) {
              return _this5.showToast(str);
            });
          } else {
            this.translate.get('ERROR_NETWORK').subscribe(function (str) {
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 10:
                    ...
                    return _context4.abrupt("return", this.goBack());
                  ...
                  case 17:
                    this.addresses = _context4.sent;

                    if (this.cart.shipping && this.addresses.length) {
                      shipping = this.addresses.find(function (address) {
                        return address.id === _this6.cart.shipping.id;
                      });
        ...
        key: "onPresentCardAddModal",
        value: function onPresentCardAddModal() {
        ...
        key: "onPresentAddressAddModal",
        value: function onPresentAddressAddModal() {
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 10:
                    ...
                    if (data) {
                      this.addresses = [data].concat(_toConsumableArray(this.addresses));
        ...
        value: function onPlaceOrder() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
            ...
            var message, _message, _message2, _message3, _message4, order, matches, value, formattedValue, _matches2, _value2, _formattedValue2;
              ...
              while (1) {
                switch (_context9.prev = _context9.next) {
                  case 0:
                    ...
                    _context9.next = 4;
                    return this.getTrans('CHECKOUT_EMAIL_REQUIRED');

                  case 4:
                    message = _context9.sent;
                    return _context9.abrupt("return", this.showToast(message));

                  case 8:
                    if (!this.form.controls['contactEmail'].hasError('email')) {
                      _context9.next = 15;
                      break;
                    }

                    _context9.next = 11;
                    return this.getTrans('CHECKOUT_EMAIL_INVALID');

                  case 11:
                    _message = _context9.sent;
                    return _context9.abrupt("return", this.showToast(_message));

                  case 15:
                    if (!this.form.controls['shipping'].hasError('required')) {
                      _context9.next = 22;
                      break;
                    }

                    _context9.next = 18;
                    return this.getTrans('CHECKOUT_ADDRESS_REQUIRED');

                  case 18:
                    _message2 = _context9.sent;
                    return _context9.abrupt("return", this.showToast(_message2));

                  case 22:
                    if (!this.form.controls['paymentMethod'].hasError('required')) {
                      _context9.next = 29;
                      break;
                    }

                    _context9.next = 25;
                    return this.getTrans('CHECKOUT_PAYMENT_METHOD_REQUIRED');

                  case 25:
                    _message3 = _context9.sent;
                    return _context9.abrupt("return", this.showToast(_message3));

                  case 29:
                    if (!this.form.controls['card'].hasError('required')) {
                      _context9.next = 36;
                      break;
                    }

                    _context9.next = 32;
                    return this.getTrans('CHECKOUT_CARD_REQUIRED');

                  case 32:
                    _message4 = _context9.sent;
                    return _context9.abrupt("return", this.showToast(_message4));
                  ...
                  case 36:
                    ...
                    return _context9.abrupt("return", this.translate.get('INVALID_FORM').subscribe(function (str) {
                  ...
                  case 47:
                    ...
                    if (_context9.t0.code === 1001) {
                      this.translate.get('ACCOUNT_BLOCKED').subscribe(function (str) {
                        return _this7.showToast(str);
                      });
                    } else if (_context9.t0.code === 1002) {
                      this.translate.get('CARD_DECLINED').subscribe(function (str) {
                        return _this7.showToast(str);
                      });
                    } else if (_context9.t0.code === 1004) {
                      matches = _context9.t0.message.match(/\%(.*?)\%/);

                      if (matches) {
                        value = matches[1];
                        formattedValue = this.currencyGlobalPipe.transform(value);
                        this.translate.get('ERROR_MINIMUM_ORDER_AMOUNT', {
                          value: formattedValue
                        }).subscribe(function (str) {
                          return _this7.showToast(str);
                        });
                      }
                    } else if (_context9.t0.code === 1005) {
                      _matches2 = _context9.t0.message.match(/\%(.*?)\%/);

                      if (_matches2) {
                        _value2 = _matches2[1];
                        _formattedValue2 = this.currencyGlobalPipe.transform(_value2);
                        this.translate.get('ERROR_MAXIMUM_ORDER_AMOUNT', {
                          value: _formattedValue2
                        }).subscribe(function (str) {
                          return _this7.showToast(str);
                        });
                      }
                    } else if (_context9.t0.code === 1006) {
                      this.onPresentSignUpModal();
                      this.translate.get('ERROR_CHECKOUT_GUEST_DISABLED').subscribe(function (str) {
                        return _this7.showToast(str, 'top');
                      });
                    } else {
                      this.showCouponErrorsIfNeeded(_context9.t0);
                    }
    ...
    CheckoutPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵProvidersFeature"]([src_app_pipes_currency_global__WEBPACK_IMPORTED_MODULE_10__["CurrencyGlobalPipe"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]],
      decls: 13,
      vars: 7,
      ...
      pipes: [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_19__["TranslatePipe"], src_app_pipes_currency_global__WEBPACK_IMPORTED_MODULE_10__["CurrencyGlobalPipe"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](CheckoutPage, [{
        ...
        return [{
          ...
          type: src_app_pipes_currency_global__WEBPACK_IMPORTED_MODULE_10__["CurrencyGlobalPipe"]
        }, {
