...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesOrderTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Order = /*#__PURE__*/function (_parse__WEBPACK_IMPOR) {
      _inherits(Order, _parse__WEBPACK_IMPOR);
      ...
      _createClass(Order, [{
        key: "isShippedOut",
        value: function isShippedOut() {
          return this.status === 'Shipped Out';
        }
      }, {
        key: "isDelivered",
        value: function isDelivered() {
          return this.status === 'Delivered';
        }
      }, {
        key: "prettyItems",
        value: function prettyItems() {
        ...
        key: "load",
        value: function load() {
          var query = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"](Order);
        ...
        value: function markAsDelivered() {
          var id = this.id;
          return parse__WEBPACK_IMPORTED_MODULE_1__["Cloud"].run('markOrderAsDelivered', {
            id: id
          });
        }
      }, {
        key: "reviewItem",
        value: function reviewItem() {
          var review = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          var id = this.id;
          return parse__WEBPACK_IMPORTED_MODULE_1__["Cloud"].run('reviewOrderItem', Object.assign({
            id: id
          }, review));
        }
      }, {
  ...
  /***/
  function srcAppServicesPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Page = /*#__PURE__*/function (_parse__WEBPACK_IMPOR2) {
      _inherits(Page, _parse__WEBPACK_IMPOR2);
      ...
      function Page() {
        ...
        return _super2.call(this, 'Page');
      }

      _createClass(Page, [{
        key: "load",
        value: function load() {
          var query = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"](Page);
    ...
    Page.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: Page,
      factory: Page.ɵfac,
      providedIn: 'root'
    });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Page, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  /***/
  function srcAppServicesReviewTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Review = /*#__PURE__*/function (_parse__WEBPACK_IMPOR3) {
      _inherits(Review, _parse__WEBPACK_IMPOR3);

      var _super3 = _createSuper(Review);

      function Review() {
        _classCallCheck(this, Review);

        return _super3.call(this, 'Review');
      }
      ...
      _createClass(Review, [{
        ...
        value: function load() {
          ...
          var query = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"](Review);
    ...
    Review.ɵfac = function Review_Factory(t) {
      return new (t || Review)();
    };

    Review.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: Review,
      factory: Review.ɵfac,
      providedIn: 'root'
    });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Review, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
