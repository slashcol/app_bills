...
/* harmony import */ var _services_category__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/category */ "./src/app/services/category.ts");
/* harmony import */ var _services_item__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/item */ "./src/app/services/item.ts");
/* harmony import */ var _services_card__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/card */ "./src/app/services/card.ts");
/* harmony import */ var _services_preference__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./services/preference */ "./src/app/services/preference.ts");
/* harmony import */ var _services_cart__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./services/cart */ "./src/app/services/cart.ts");
...
/* harmony import */ var _services_local_storage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/local-storage */ "./src/app/services/local-storage.ts");
/* harmony import */ var _services_installation__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./services/installation */ "./src/app/services/installation.ts");
/* harmony import */ var _services_window_ref__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services/window-ref */ "./src/app/services/window-ref.ts");
/* harmony import */ var _ionic_native_header_color_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ionic-native/header-color/ngx */ "./node_modules/@ionic-native/header-color/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var parse__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! parse */ "./node_modules/parse/index.js");
/* harmony import */ var parse__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(parse__WEBPACK_IMPORTED_MODULE_17__);
/* harmony import */ var _services_slide__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./services/slide */ "./src/app/services/slide.ts");
...
/* harmony import */ var _nomadreservations_ngx_stripe__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @nomadreservations/ngx-stripe */ "./node_modules/@nomadreservations/ngx-stripe/__ivy_ngcc__/fesm2015/nomadreservations-ngx-stripe.js");
/* harmony import */ var _services_item_variation__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./services/item-variation */ "./src/app/services/item-variation.ts");
...
/* harmony import */ var _ionic_native_google_plus_ngx__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @ionic-native/google-plus/ngx */ "./node_modules/@ionic-native/google-plus/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _services_audio__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./services/audio */ "./src/app/services/audio.ts");
...
class AppComponent {
    constructor(platform, router, toastCtrl, alertCtrl, preference, loadingCtrl, cartService, statusBar, headerColor, translate, localStorage, userService, windowRef, installationService, stripeService, googlePlus, authService, audioService, ngZone, splashScreen) {
    ...
    setupDesktopAnimations() {
        if (this.platform.is('desktop')) {
            const config = new _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Config"];
    ...
    setupLanguage() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let lang = yield this.localStorage.getLang();
    ...
    setupEvents() {
        ...
        window.addEventListener('cart:expired', (e) => {
            const cart = e.detail;
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                if (this.objWindow.ParsePushPlugin) {
                    ...
                    const obj = yield this.installationService.getOne(id);
                    if (obj) {
                    ...
                    const res = yield this.installationService.save(id, payload);
    ...
    showNotification(notification) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const viewText = yield this.translate.get('VIEW').toPromise();
            let buttons = null;
    ...
    showConfirm(message) {
        return new Promise((resolve, reject) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const str = yield this.translate.get(['OK', 'CANCEL']).toPromise();
    ...
    showLoadingView() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const str = yield this.translate.get('LOADING').toPromise();
    ...
    dismissLoadingView() {
        if (this.loader) {
            this.loader.dismiss()
                .catch((e) => console.log('ERROR CATCH: LoadingController dismiss', e));
        }
    }
    showToast(message, buttons = null, duration = 3000) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const closeText = yield this.translate.get('CLOSE').toPromise();
    ...
    logout(ev = {}) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                if (!ev.silent) {
                    let str = yield this.translate.get('LOGOUT_CONFIRMATION').toPromise();
                    yield this.showConfirm(str);
                }
                const authData = this.user.attributes.authData;
                yield this.showLoadingView();
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 2, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonApp"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonRouterOutlet"]], encapsulation: 2 });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppComponent, [{
    ...
    }], function () { return [{ type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_19__["Router"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"] }, { type: _services_preference__WEBPACK_IMPORTED_MODULE_10__["Preference"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"] }, { type: _services_cart__WEBPACK_IMPORTED_MODULE_11__["Cart"] }, { type: _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"] }, { type: _ionic_native_header_color_ngx__WEBPACK_IMPORTED_MODULE_16__["HeaderColor"] }, { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_12__["TranslateService"] }, { type: _services_local_storage__WEBPACK_IMPORTED_MODULE_13__["LocalStorage"] }, { type: _services_user__WEBPACK_IMPORTED_MODULE_5__["User"] }, { type: _services_window_ref__WEBPACK_IMPORTED_MODULE_15__["WindowRef"] }, { type: _services_installation__WEBPACK_IMPORTED_MODULE_14__["Installation"] }, { type: _nomadreservations_ngx_stripe__WEBPACK_IMPORTED_MODULE_20__["StripeService"] }, { type: _ionic_native_google_plus_ngx__WEBPACK_IMPORTED_MODULE_23__["GooglePlus"] }, { type: angularx_social_login__WEBPACK_IMPORTED_MODULE_22__["SocialAuthService"] }, { type: _services_audio__WEBPACK_IMPORTED_MODULE_24__["AudioService"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"] }, { type: _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"] }]; }, null); })();
...
/* harmony import */ var _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @ionic-native/native-audio/ngx */ "./node_modules/@ionic-native/native-audio/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_sign_in_with_apple_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ionic-native/sign-in-with-apple/ngx */ "./node_modules/@ionic-native/sign-in-with-apple/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ionic-native/social-sharing/ngx */ "./node_modules/@ionic-native/social-sharing/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_header_color_ngx__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @ionic-native/header-color/ngx */ "./node_modules/@ionic-native/header-color/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_safari_view_controller_ngx__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @ionic-native/safari-view-controller/ngx */ "./node_modules/@ionic-native/safari-view-controller/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_google_plus_ngx__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @ionic-native/google-plus/ngx */ "./node_modules/@ionic-native/google-plus/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _fortawesome_free_brands_svg_icons_faFacebookF__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(_fortawesome_free_brands_svg_icons_faFacebookF__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var _fortawesome_free_brands_svg_icons_faTwitter__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @fortawesome/free-brands-svg-icons/faTwitter */ "./node_modules/@fortawesome/free-brands-svg-icons/faTwitter.js");
/* harmony import */ var _fortawesome_free_brands_svg_icons_faTwitter__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(_fortawesome_free_brands_svg_icons_faTwitter__WEBPACK_IMPORTED_MODULE_22__);
/* harmony import */ var _fortawesome_free_brands_svg_icons_faWhatsapp__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @fortawesome/free-brands-svg-icons/faWhatsapp */ "./node_modules/@fortawesome/free-brands-svg-icons/faWhatsapp.js");
/* harmony import */ var _fortawesome_free_brands_svg_icons_faWhatsapp__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(_fortawesome_free_brands_svg_icons_faWhatsapp__WEBPACK_IMPORTED_MODULE_23__);
...
/* harmony import */ var _nomadreservations_ngx_stripe__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @nomadreservations/ngx-stripe */ "./node_modules/@nomadreservations/ngx-stripe/__ivy_ngcc__/fesm2015/nomadreservations-ngx-stripe.js");
...
/* harmony import */ var _ngx_translate_http_loader__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! @ngx-translate/http-loader */ "./node_modules/@ngx-translate/http-loader/__ivy_ngcc__/fesm2015/ngx-translate-http-loader.js");
/* harmony import */ var ng_lazyload_image__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ng-lazyload-image */ "./node_modules/ng-lazyload-image/__ivy_ngcc__/fesm2015/ng-lazyload-image.js");
/* harmony import */ var _ionic_storage__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! @ionic/storage */ "./node_modules/@ionic/storage/__ivy_ngcc__/fesm2015/ionic-storage.js");
/* harmony import */ var ngx_img_fallback__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ngx-img-fallback */ "./node_modules/ngx-img-fallback/__ivy_ngcc__/fesm2015/ngx-img-fallback.js");
/* harmony import */ var _angular_service_worker__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! @angular/service-worker */ "./node_modules/@angular/service-worker/__ivy_ngcc__/fesm2015/service-worker.js");
...
/* harmony import */ var angularx_social_login__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! angularx-social-login */ "./node_modules/angularx-social-login/__ivy_ngcc__/fesm2015/angularx-social-login.js");
/* harmony import */ var _angular_common_locales_ar__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! @angular/common/locales/ar */ "./node_modules/@angular/common/locales/ar.js");
/* harmony import */ var _angular_common_locales_ar__WEBPACK_IMPORTED_MODULE_36___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_ar__WEBPACK_IMPORTED_MODULE_36__);
/* harmony import */ var _angular_common_locales_es__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! @angular/common/locales/es */ "./node_modules/@angular/common/locales/es.js");
/* harmony import */ var _angular_common_locales_es__WEBPACK_IMPORTED_MODULE_37___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_es__WEBPACK_IMPORTED_MODULE_37__);
...
const icons = [_fortawesome_free_brands_svg_icons_faFacebookF__WEBPACK_IMPORTED_MODULE_21__["faFacebookF"], _fortawesome_free_brands_svg_icons_faTwitter__WEBPACK_IMPORTED_MODULE_22__["faTwitter"], _fortawesome_free_brands_svg_icons_faWhatsapp__WEBPACK_IMPORTED_MODULE_23__["faWhatsapp"]];
_fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_20__["library"].add(...icons);
...
AppModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: AppModule, bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_26__["AppComponent"]] });
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        ...
        _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_14__["NativeAudio"],
        _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_16__["SocialSharing"],
        _ionic_native_header_color_ngx__WEBPACK_IMPORTED_MODULE_17__["HeaderColor"],
        _ionic_native_safari_view_controller_ngx__WEBPACK_IMPORTED_MODULE_18__["SafariViewController"],
        _ionic_native_sign_in_with_apple_ngx__WEBPACK_IMPORTED_MODULE_15__["SignInWithApple"],
        ...
        { provide: _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicRouteStrategy"] }
            ...
            _nomadreservations_ngx_stripe__WEBPACK_IMPORTED_MODULE_27__["NgxStripeModule"].forRoot(_environments_environment__WEBPACK_IMPORTED_MODULE_34__["environment"].stripePublicKey),
            ...
            ng_lazyload_image__WEBPACK_IMPORTED_MODULE_30__["LazyLoadImageModule"].forRoot({
            ...
            ngx_img_fallback__WEBPACK_IMPORTED_MODULE_32__["ImgFallbackModule"],
            _angular_service_worker__WEBPACK_IMPORTED_MODULE_33__["ServiceWorkerModule"].register('ngsw-worker.js', { enabled: _environments_environment__WEBPACK_IMPORTED_MODULE_34__["environment"].production }),
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_26__["AppComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["BrowserModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicModule"], _nomadreservations_ngx_stripe__WEBPACK_IMPORTED_MODULE_27__["NgxStripeModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_25__["AppRoutingModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"],
        angularx_social_login__WEBPACK_IMPORTED_MODULE_35__["SocialLoginModule"], ng_lazyload_image__WEBPACK_IMPORTED_MODULE_30__["LazyLoadImageModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_28__["TranslateModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_31__["IonicStorageModule"], ngx_img_fallback__WEBPACK_IMPORTED_MODULE_32__["ImgFallbackModule"], _angular_service_worker__WEBPACK_IMPORTED_MODULE_33__["ServiceWorkerModule"]] }); })();
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic-native/native-audio/ngx */ "./node_modules/@ionic-native/native-audio/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
...
class AudioService {
    constructor(nativeAudio, platform) {
...
AudioService.ɵfac = function AudioService_Factory(t) { return new (t || AudioService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_1__["NativeAudio"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AudioService, [{
    ...
    }], function () { return [{ type: _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_1__["NativeAudio"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"] }]; }, null); })();
...
/* harmony import */ var _category__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./category */ "./src/app/services/category.ts");




class Brand extends parse__WEBPACK_IMPORTED_MODULE_1__["Object"] {
    constructor() {
        super('Brand');
    }
    static getInstance() {
    ...
    load(params = {}) {
        const query = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"](Brand);
        if (Array.isArray(params.categories)) {
            const categories = params.categories.map((id) => {
                const obj = new _category__WEBPACK_IMPORTED_MODULE_2__["Category"];
                obj.id = id;
                return obj;
            });
            ...
            const category = new _category__WEBPACK_IMPORTED_MODULE_2__["Category"];
...
Brand.ɵfac = function Brand_Factory(t) { return new (t || Brand)(); };
Brand.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: Brand, factory: Brand.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Brand, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
class Card extends parse__WEBPACK_IMPORTED_MODULE_1__["Object"] {
    constructor() {
        super('Card');
    }
    formatBrand() {
    ...
    load() {
        const query = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"](Card);
...
Card.ɵfac = function Card_Factory(t) { return new (t || Card)(); };
Card.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: Card, factory: Card.ɵfac, providedIn: 'root' });
...
class Cart extends parse__WEBPACK_IMPORTED_MODULE_1__["Object"] {
    constructor() {
        super('Cart');
    ...
    applyCoupon(couponCode) {
        return parse__WEBPACK_IMPORTED_MODULE_1__["Cloud"].run('applyCoupon', { couponCode });
    }
    removeCoupon() {
        return parse__WEBPACK_IMPORTED_MODULE_1__["Cloud"].run('removeCoupon');
    }
    getOne() {
        const query = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"](Cart);
...
class Category extends parse__WEBPACK_IMPORTED_MODULE_1__["Object"] {
    constructor() {
        super('Category');
    }
    static getInstance() {
    ...
    load(params = {}) {
        const query = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"](Category);
        if (params.canonical) {
...
Category.ɵfac = function Category_Factory(t) { return new (t || Category)(); };
Category.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: Category, factory: Category.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Category, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
/* harmony import */ var _window_ref__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./window-ref */ "./src/app/services/window-ref.ts");
    ...
    getId() {
        return new Promise((resolve, reject) => {
            this.windowRef.nativeWindow.ParsePushPlugin
                .getInstallationObjectId((id) => resolve(id), err => reject(err));
        });
    }
    getOne(id) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('X-Parse-Application-Id', src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].appId);
        let url = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverUrl}/installations/${id}`;
...
Installation.ɵfac = function Installation_Factory(t) { return new (t || Installation)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_window_ref__WEBPACK_IMPORTED_MODULE_2__["WindowRef"])); };
Installation.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: Installation, factory: Installation.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Installation, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }, { type: _window_ref__WEBPACK_IMPORTED_MODULE_2__["WindowRef"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ItemVariation", function() { return ItemVariation; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var parse__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! parse */ "./node_modules/parse/index.js");
/* harmony import */ var parse__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(parse__WEBPACK_IMPORTED_MODULE_1__);
...
class ItemVariation extends parse__WEBPACK_IMPORTED_MODULE_1__["Object"] {
    constructor() {
        super('ItemVariation');
    }
    static getInstance() {
...
ItemVariation.ɵfac = function ItemVariation_Factory(t) { return new (t || ItemVariation)(); };
ItemVariation.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: ItemVariation, factory: ItemVariation.ɵfac });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ItemVariation, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
    }], function () { return []; }, null); })();
...
/* harmony import */ var parse__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! parse */ "./node_modules/parse/index.js");
/* harmony import */ var parse__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(parse__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _brand__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./brand */ "./src/app/services/brand.ts");
/* harmony import */ var _category__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./category */ "./src/app/services/category.ts");
/* harmony import */ var _sub_category__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sub-category */ "./src/app/services/sub-category.ts");
...
class Item extends parse__WEBPACK_IMPORTED_MODULE_1__["Object"] {
    constructor() {
        super('Item');
    }
    static getInstance() {
    ...
    loadOne(id) {
        const query = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"](Item);
    ...
    load(params = {}) {
        ...
        if (params.tag) {
            const searchQuery = params.tag.toLowerCase()
                .normalize("NFD")
                .replace(/[\u0300-\u036f]/g, "");
            const queryTag = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"]('Item');
            queryTag.contains('tags', searchQuery);
            queries.push(queryTag);
            const queryCanonical = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"]('Item');
            queryCanonical.contains('canonical', searchQuery);
            queries.push(queryCanonical);
        }
        let mainQuery = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"]('Item');
        if (queries.length) {
            mainQuery = parse__WEBPACK_IMPORTED_MODULE_1__["Query"].or(...queries);
        }
        if (params.priceMin) {
        ...
        if (params.cat) {
            if (Array.isArray(params.cat)) {
                const categories = params.cat.map((id) => {
                    const obj = new _category__WEBPACK_IMPORTED_MODULE_3__["Category"];
                    obj.id = id;
                    return obj;
                });
                if (categories.length) {
                ...
                const category = new _category__WEBPACK_IMPORTED_MODULE_3__["Category"];
        ...
        if (params.subcat) {
            if (Array.isArray(params.subcat)) {
                const subcats = params.subcat.map((id) => {
                    const obj = new _sub_category__WEBPACK_IMPORTED_MODULE_4__["SubCategory"];
                    obj.id = id;
                    return obj;
                });
                if (subcats.length) {
                ...
                const subcat = new _sub_category__WEBPACK_IMPORTED_MODULE_4__["SubCategory"];
        ...
        if (params.brand) {
            if (Array.isArray(params.brand)) {
                const brands = params.brand.map((id) => {
                    const obj = new _brand__WEBPACK_IMPORTED_MODULE_2__["Brand"];
                    obj.id = id;
                    return obj;
                });
                if (brands.length) {
                ...
                const brand = new _brand__WEBPACK_IMPORTED_MODULE_2__["Brand"];
    ...
    like(itemId) {
        return parse__WEBPACK_IMPORTED_MODULE_1__["Cloud"].run('likeItem', { itemId: itemId });
    }
    isLiked(itemId) {
        return parse__WEBPACK_IMPORTED_MODULE_1__["Cloud"].run('isItemLiked', { itemId: itemId });
    }
    trackView(itemId) {
        return parse__WEBPACK_IMPORTED_MODULE_1__["Cloud"].run('trackViewItem', { itemId: itemId });
    }
    get objectId() {
...
Item.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: Item, factory: Item.ɵfac, providedIn: 'root' });
...
LocalStorage.ɵfac = function LocalStorage_Factory(t) { return new (t || LocalStorage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ionic_storage__WEBPACK_IMPORTED_MODULE_1__["Storage"])); };
LocalStorage.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: LocalStorage, factory: LocalStorage.ɵfac, providedIn: 'root' });
...
Preference.ɵfac = function Preference_Factory(t) { return new (t || Preference)(); };
Preference.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: Preference, factory: Preference.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Preference, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
class Slide extends parse__WEBPACK_IMPORTED_MODULE_1__["Object"] {
    constructor() {
        super('SlideImage');
    }
    static getInstance() {
...
Slide.ɵfac = function Slide_Factory(t) { return new (t || Slide)(); };
Slide.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: Slide, factory: Slide.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Slide, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
class SubCategory extends parse__WEBPACK_IMPORTED_MODULE_1__["Object"] {
    constructor() {
        super('SubCategory');
    }
    load(params = {}) {
        const query = new parse__WEBPACK_IMPORTED_MODULE_1__["Query"](SubCategory);
        if (params.category) {
...
SubCategory.ɵfac = function SubCategory_Factory(t) { return new (t || SubCategory)(); };
SubCategory.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: SubCategory, factory: SubCategory.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SubCategory, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
class User extends parse__WEBPACK_IMPORTED_MODULE_1__["User"] {
    constructor() {
        super();
    }
    static getInstance() {
    ...
    becomeWithSessionToken(sessionToken) {
        return User.become(sessionToken);
    }
    loginWith(provider, authData = {}, extraData = {}) {
        const user = new User;
        user.set(extraData);
...
module.exports = __webpack_require__(/*! C:\Users\usuario\Downloads\EVANS\IonShop_Recursos\ionshop-3.1.3\app\src\main.ts */"./src/main.ts");
