...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-brand-list-brand-list-module"], {
  ...
  function srcAppPagesBrandListBrandListPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_app_config__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    function BrandListPage_div_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function BrandListPage_empty_view_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function BrandListPage_empty_view_13_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "empty-view", 11);
    ...
    function BrandListPage_div_14_ion_row_10_ion_col_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function BrandListPage_div_14_ion_row_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function BrandListPage_div_14_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function BrandListPage_ion_row_15_ion_col_1_ion_text_5_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var brand_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
    ...
    function BrandListPage_ion_row_15_ion_col_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function BrandListPage_ion_row_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-row");
    ...
    var BrandListPage = /*#__PURE__*/function (_base_page_base_page_) {
      _inherits(BrandListPage, _base_page_base_page_);

      var _super = _createSuper(BrandListPage);

      function BrandListPage(injector, appConfigService, brandService) {
        var _this;
    ...
    BrandListPage.ɵfac = function BrandListPage_Factory(t) {
      return new (t || BrandListPage)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_services_app_config__WEBPACK_IMPORTED_MODULE_7__["AppConfigService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_services_brand__WEBPACK_IMPORTED_MODULE_3__["Brand"]));
    };
    ...
    BrandListPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      template: function BrandListPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ionRefresh", function BrandListPage_Template_ion_refresher_ionRefresh_6_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](BrandListPage, [{
        ...
        return [{
          ...
          type: src_app_services_app_config__WEBPACK_IMPORTED_MODULE_7__["AppConfigService"]
        }, {
